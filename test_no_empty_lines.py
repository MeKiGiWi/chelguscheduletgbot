#!/usr/bin/env python3
"""
Test script to verify the updated formatting without empty lines between blockquotes
"""
...
def test_no_empty_lines():
    """Test updated formatting without empty lines between blockquotes"""
    print("Testing updated formatting without empty lines between blockquotes...")
    ...
    # Print final output
    print("\n" + "=" * 60)
    print("FORMATTING WITHOUT EMPTY LINES OUTPUT")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("NO EMPTY LINES TEST PASSED!")
    print("All content is properly formatted without empty lines:")
