#!/usr/bin/env python3
"""
Final comprehensive test with all updates
"""
...
def test_final_with_all_updates():
    """Test final comprehensive functionality with all updates"""
    print("Running final comprehensive test with all updates...")
    ...
    for i, (schedule, offset) in enumerate(
        ...
        assert (
            "Выходной\n</blockquote>" in schedule
        ), f"Schedule {i} should have newline after 'Выходной'"

    print("✓ Schedule content verified")

    # Print final output
    print("\n" + "=" * 70)
    print("FINAL COMPREHENSIVE TEST OUTPUT WITH ALL UPDATES")
    print("=" * 70)
    ...
    print("All features are working correctly with all updates:")
