#!/usr/bin/env python3
"""
Test script to verify the updated formatting v3
"""
...
def test_updated_formatting_v3():
    """Test updated formatting v3"""
    print("Testing updated formatting v3...")
    ...
    # Check that blockquotes are separated by newlines
    blockquote_separation = schedule_message.count("</blockquote>\n<blockquote>")
    print(f"✓ Blockquote separation count: {blockquote_separation}")

    # Print final output
    print("\n" + "=" * 70)
    print("UPDATED FORMATTING V3 OUTPUT")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("UPDATED FORMATTING V3 TEST PASSED!")
    ...
    print(
        "  ✓ Newline after 'Выходной' and after </blockquote> to prevent merging on mobile"
    )
    print("  ✓ Separation between blockquotes with newlines")
