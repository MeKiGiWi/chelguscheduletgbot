#!/usr/bin/env python3
"""
Test script to verify the updated formatting v4
"""
...
def test_updated_formatting_v4():
    """Test updated formatting v4"""
    print("Testing updated formatting v4...")
    ...
    assert (
        "Выходной\n</blockquote>\n" in schedule_message
    ), "Message should have newline after 'Выходной' and after </blockquote>"

    print("✓ Newline after 'Выходной' and after </blockquote> verified")

    # Check that blockquotes have only one newline after them
    blockquote_newlines = schedule_message.count("</blockquote>\n<blockquote>")
    print(f"✓ Blockquote separation with single newline: {blockquote_newlines}")

    # Print final output
    print("\n" + "=" * 70)
    print("UPDATED FORMATTING V4 OUTPUT")
    print("=" * 70)
    ...
    # Count newlines after </blockquote>
    newline_after_closing_count = schedule_message.count("</blockquote>\n")
    print(f"Newlines after </blockquote>: {newline_after_closing_count}")

    print("\n" + "=" * 70)
    print("UPDATED FORMATTING V4 TEST PASSED!")
    ...
    print("  ✓ Single newline after each blockquote")
    print("  ✓ No newlines before blockquotes")
    print("  ✓ Newline after 'Выходной' and after </blockquote>")
    print("  ✓ Proper separation between blockquotes")
